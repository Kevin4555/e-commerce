...
function SobreEsteProyecto() {
	return (
		<Container fluid>
			...
			<div class="custom-shape-divider-top-1679573669">
				<svg
					data-name="Layer 1"
			...
			<section className="platinumSection" id="infoSection">
				...
				>
					...
					<p className="px-3">
						...
						<b>eCommerce ficticio</b> realizado por 4 compañeros a
						lo largo de 3 semanas como proyecto final del{" "}
						<b>bootcamp de Hack Academy</b>. El bootcamp de
						Full-Stack development de Hack Academy es un curso
						<b> intensivo</b> de 3 meses con una carga horaria de
						más de 600 horas. En este aprendemos tecnologías de{" "}
						<b>front-end y back-end</b>, las cuales utilizamos para
